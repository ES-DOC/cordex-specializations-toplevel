<map><node BACKGROUND_COLOR="#66cc00" COLOR="#000000" FOLDED="false" STYLE="fork" TEXT="toplevel"><font BOLD="True" NAME="courier" SIZE="14" /><richcontent TYPE="NOTE"><html>
  ...
  <body>
    <dl>
        <dt><b>Description</b></dt><dd>Model top level</dd><dt><b>Spec. ID</b></dt><dd>cmip6.toplevel</dd><dt><b>Contact</b></dt><dd>Sebastien Denvil (IPSL)</dd><dt><b>Authors</b></dt><dd>Sebastien Denvil (IPSL)</dd><dt><b>Contributors</b></dt><dd>Sebastien Denvil (IPSL), Mark Greenslade (IPSL)</dd>
    </dl>
  </body>
